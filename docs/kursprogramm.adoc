...
. Klicken Sie einmal auf die Uhrzeit.
  ** Ein kleiner Kalender wird eingeblendet.
...
==== Übung 5 – Rechner öffnen und verschieben
...
[TIP]
====
Um den Splitscreen zu beenden, drücken Sie kbd:[Escape] oder klicken Sie erneut auf den grünen Knopf.
====
...
. Prüfen Sie: Ist ein Netzwerk mit Häkchen markiert? Das ist die aktuelle Verbindung.
...
. Schauen Sie sich die Seite an – scrollen Sie mit dem Mausrad oder zwei Fingern auf dem Trackpad nach unten.

[NOTE]
====
Trackpad: Streichen Sie mit zwei Fingern nach unten, um die Seite nach unten zu scrollen.
====
