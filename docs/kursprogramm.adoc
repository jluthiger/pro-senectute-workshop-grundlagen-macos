...
* Apps über das Launchpad starten und Fenster verwalten
...
| *Tag 2*
| Dateien verwalten und speichern (Finder, TextEdit, iCloud)
| 09:00–12:00
|===
...
Das *Launchpad* zeigt alle installierten Apps in einer Übersicht:

* Öffnen über: Launchpad-Symbol im Dock (Raketen-Symbol) oder Tastenkombination kbd:[F4]
* Apps können gesucht werden (Suchfeld oben)
* Apps können zu Ordnern gruppiert werden (Symbol auf Symbol ziehen)
...
==== Übung 2 – Launchpad öffnen und Taschenrechner starten

*Ziel:* Das Launchpad bedienen und ein Programm starten.

. Klicken Sie auf das *Launchpad-Symbol* im Dock (Rakete).
  ** Das Launchpad öffnet sich – alle Apps sind sichtbar.
. Schauen Sie sich die App-Symbole an.
. Klicken Sie oben in das Suchfeld und tippen Sie «Rechner».
. Klicken Sie auf *Rechner* in den Ergebnissen.
...
. Suchen Sie die App *TextEdit* (Texteditorsymbol).
. Klicken Sie auf *TextEdit*, um die App zu starten.
...
. Starten Sie den *Rechner* (Launchpad → Rechner).
...
* [x] Desktop, Menüleiste, Dock und Launchpad kennen
* [x] Apps starten und im Dock behalten
* [x] Fenster öffnen, verschieben, teilen und wechseln
* [x] WLAN prüfen und Webseite aufrufen

*Hausaufgabe (freiwillig):* Öffnen Sie zu Hause das Launchpad und starten Sie zwei verschiedene Apps.
...
* Kurze Wiederholung: Desktop, Launchpad, Fenster, WLAN
...
Öffnen über: Dock → TextEdit-Symbol (oder Launchpad → «TextEdit» eingeben)
...
==== Übung 15 – Kurzen Brief in TextEdit schreiben
...
==== Übung 18 – Ordner «Kurs» nach iCloud Drive kopieren
...
==== Übung 19 – iCloud Drive im Browser aufrufen
...
* [x] Desktop, Menüleiste, Dock und Launchpad bedienen
